...
public class DbConnectivityClass {
        ...
        final String SQL_SERVER_URL = "jdbc:mysql://csc311haris.mysql.database.azure.com/";
        public final String DB_URL = SQL_SERVER_URL + "SemLongPro";
    ...
    private final ObservableList<Person> data = FXCollections.observableArrayList();
        ...
        public boolean connectToDatabase() {
            ...
            try {
                ...
                statement.executeUpdate("CREATE DATABASE IF NOT EXISTS SemLongPro");
                statement.close();
                conn.close();
